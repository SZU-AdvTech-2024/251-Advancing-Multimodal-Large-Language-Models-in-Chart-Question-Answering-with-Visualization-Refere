...
gpu_list="${CUDA_VISIBLE_DEVICES:-1,2,3,4}"
...
# 图片目录
IMAGE_DIR="/home/lhy/datasets/ChartInstructionData/benchmark/image"

# 输出目录
OUTPUT_DIR="./playground/eval/llava-hr-ci/$(basename $BASE_MODEL)/$(date +%Y%m%d%H%M%S)"
mkdir -p $OUTPUT_DIR

# 定义数据集
declare -A QUESTION_FILES=(
    ["test"]="/home/lhy/work/InternVL/data/llava_hr_ci_test/test.jsonl"
)
