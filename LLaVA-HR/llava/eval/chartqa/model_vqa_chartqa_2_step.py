...
def eval_model(args):
    ...
    deplot_model = Pix2StructForConditionalGeneration.from_pretrained("google/deplot").to(device="cuda")
    ...
    for line in tqdm(questions):
        ...
        qs = f"The figure below is a data table. {output}\n"
        qs += f"The question is: {line['question']}\n"
        qs += "Please answer with a single word or phrase.\n"
