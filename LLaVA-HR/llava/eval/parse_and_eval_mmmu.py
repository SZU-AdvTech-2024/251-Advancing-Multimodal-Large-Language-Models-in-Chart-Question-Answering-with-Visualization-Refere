...
from llava.eval.mmmu_utils.data_utils import save_json, CAT_SHORT2LONG
from llava.eval.mmmu_utils.eval_utils import evaluate, parse_multi_choice_response, parse_open_response
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--path", type=str, default="./example_outputs/llava1.5_13b", help="The path to model output directory."
    )
    parser.add_argument(
        "--subject", nargs="+", help=f"The name of the mmmu sub-category. Availble: {CAT_SHORT2LONG.keys()} or ALL"
    )
