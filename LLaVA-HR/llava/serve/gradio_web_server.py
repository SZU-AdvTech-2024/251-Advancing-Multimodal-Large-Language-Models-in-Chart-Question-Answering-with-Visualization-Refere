...
title_markdown = """
# 🌋 LLaVA-ChartAssistant: Automatic Chart Analysis Assistant
"""
    ...
    with gr.Blocks(title="LLaVA", theme=gr.themes.Default(), css=block_css) as demo:
        ...
        with gr.Row():
            with gr.Column(scale=3):
                ...
                gr.Examples(
                    examples=[
                        [f"{cur_dir}/examples/two_col_862.png", "Please describe this chart?"],
                        [
                            f"{cur_dir}/examples/two_col_940.png",
                            "What are the things I should be cautious about this chart?",
                        ],
                    ],
